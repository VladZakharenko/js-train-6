...
function hasProperty(obj, property) {
  let result = property in obj
  return result ? `Property ${property} exists` : `Property ${property} does not exist`
...
function printProductDetails(obj) {
  let {productName, price} = obj
  let {companyName, country} = obj.manufacturer
  console.log(productName, price, companyName)
